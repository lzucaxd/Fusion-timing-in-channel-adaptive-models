"""
Simple training script: One DataLoader per dataset, randomly sample batches.
"""
...
def main():
    parser = argparse.ArgumentParser(description="Train BoC-ViT on CHAMMI")
    ...
    parser.add_argument("--aggregator-mode", type=str, default="mean", choices=["mean", "attn"])
